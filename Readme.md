...
# Parsing + Configuration Script – S700 - Rev. A

This **Parsing + Configuration** script is designed for the **S700** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – S700 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **S700** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
